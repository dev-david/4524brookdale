				...
				<!-- Intro -->
					<section id="top" class="one">
						<div class="container">
							...
							<header>
								<h2 class="alt">Thinking about selling <span class="blackblock"> 4524 Brookdale Ave? </span> Let us help! This is YOUR personal team of professionals. Whether you have questions about purchasing or selling, you can rest assured when you have your own Team of Fast Agents backing you.</h2>
							</header>
					...
					<section id="about" class="three">
						<div class="container">
							...
							<header>
								...
								<h3 style="color: #ecf0f1;">Properties sold within area of 4524 Brookdale Ave</h3>
							</header>
							<div class="row">
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>2551 Renwick Street</strong></h3>
										<ul>
											<li>4 Bed - 1 Bath</li>
								...
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>2133 48th Ave</strong></h3>
										<ul>
											<li>4 Bed - 2 Bath</li>
											<li>1,712 Sq Ft - 5,110 Lot</li>
											<li>List: 6/28/13 - Pending: 7/11/13</li>
											<li>List: $349,000 - SOLD $380,000</li>
										</ul>
									</article>
								</div>
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>3012 Rawson St</strong></h3>
										<ul>
											<li>4 Bed - 2 Bath</li>
											<li>2,016 Sq Ft - 3,880 Lot</li>
											<li>List: 2/2/13 - Pending: 7/12/13</li>
											<li>List: $499,000 - SOLD $500,000</li>
										</ul>
									</article>
								</div>
							</div>
